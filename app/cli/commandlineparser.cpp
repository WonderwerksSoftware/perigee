...
GlobalCommandLineParser::ParseResult GlobalCommandLineParser::parse(const QStringList &args)
{
    ...
    parser.setApplicationDescription(
        "\n"
        "Starts Perigee normally if no arguments are given.\n"
        "\n"
        "Available actions:\n"
        ...
        "\n"
        "See 'perigee <action> --help' for help of a specific action."
    );
...
void StreamCommandLineParser::parse(const QStringList &args, StreamingPreferences *preferences)
{
    ...
    parser.addToggleOption("mute-on-focus-loss", "mute audio when the Perigee window loses focus");
